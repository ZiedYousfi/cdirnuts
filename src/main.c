...
// Actual main function code is commented out for now.
// Uncomment the following lines to use the main function code.
//   int result = 0;
...
//           log_message(
//               LOG_ERROR,
//               "--config as first argument but no config file path
//               provided");
//           result = 1;
//           goto cleanup_main;
//         }
...
//   return result;
  ...
  char pathTest[] = "/home/user/projects/my_project/src/main.c";
